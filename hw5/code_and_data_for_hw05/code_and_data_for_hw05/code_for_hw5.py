...
def d_square_loss_th0(x, y, th, th0):
    ...
    """
    # Your code here
    return d_lin_reg_th0(x, th, th0) * 2 * (lin_reg(x, th, th0) - y)
...
def sgd(X, y, J, dJ, w0, step_size_fn, max_iter):
    ...
    def sgd(X, y, J, dJ, w0, step_size_fn, max_iter):
        ...
        for i in range(0, max_iter):
            ...
            ws.append(w)
            fs.append(J(X[:, n:n + 1], y[:, n:n + 1], w))
            w = w - step_size_fn(i) * dJ(X[:, n:n + 1], y[:, n:n + 1], w)
...
def sgdTest():
    ...
    return sgd(X, y, J, dJ, w0=np.ones((X.shape[0],1)),step_size_fn=svm_min_step_size_fn, max_iter=1000)
